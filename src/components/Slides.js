...
const toyImages = async () => {
  ...
  console.log(response.data.results[1].urls.full);
  return `'${response.data.results[1].urls.full}'`;
};

async function Slides() {
  const img = await toyImages();
  ...
  return `
        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url(${img});">
